...
| Sealed SH main | `scripthash.head/NN.mphf` + `.val` | Electrum **scripthash prefix** → pack8 locators. Compact BDZ3: packed 2-bit `g` FdOnly; occupancy mapped (prefix through occ, not tags); tags/val FdOnly. | After tip bulk |
