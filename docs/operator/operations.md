...
| `--block-filter-index` | `block_filter_index=` | **off** — BIP158 basic filters. Independent of `--sh-index`. P2P `NODE_COMPACT_FILTERS`, `getblockfilter`, and `/rest/blockfilter/` wait until the filter watermark is the tip |
