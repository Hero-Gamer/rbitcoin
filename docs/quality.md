...
| **Q-65** | BIP157/158 compact block filters | Shipped as optional `--block-filter-index` (basic / type 0). `NODE_COMPACT_FILTERS` and `getblockfilter` follow the filter watermark, not the scripthash watermark. | — |
