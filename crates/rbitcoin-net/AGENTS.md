...
| Published mempool snapshots (fees; unix `/internal` lazy tx JSON) | [`docs/mempool-fee-estimation.md`](../../docs/mempool-fee-estimation.md), [`docs/ibd-memory.md`](../../docs/ibd-memory.md), [`COMPAT.md`](../../COMPAT.md) |
