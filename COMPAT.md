...
| Pruning / GUI | inwit watermark / `NETWORK_LIMITED` (`--prune-inwit`; witness bytes at/below watermark are compacted to fixed stubs); not Core `-prune` of headers/txout | Supported |
