...
| Probe | Open OA: page-local double-hash (1024 slots/page); one 4 KiB load. Sealed: RAM fuse skip; sealed-hot (ages `1..=3`) unpack BDZ `g` into process RAM; colder ages unique 4 KiB packed `g` pages; MPHF output is `rel−1` |
