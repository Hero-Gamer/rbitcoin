...
**Current layout:** [`SCHEMA.md`](./SCHEMA.md) (`SCHEMA_VERSION = 23`).
...
|--------:|-----------------|---------------------------|
| **23** | `create.loc.ovf` 16 B (u32 strides / `n_out`). Occupied 22 rewrites 12 B ovf. Occupied 15–21 Class A refused. | **Current** |
