...
wipe), and there is **no** long-term support SLA. **0.7.x** is the supported
published line until 0.8 or 1.0. Occupied **0.6.x** stores refuse (wipe +
IBD). Run signet first, then mainnet with monitoring. See
